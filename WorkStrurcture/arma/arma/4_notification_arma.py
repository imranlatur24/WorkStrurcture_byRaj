...
def mydata(each):
    with app.app_context():
        ...
        # try:
        cursor.execute("select * from armablog_filepath WHERE TITLE LIKE %s", ("%" + search_data,))
        ...
        for row in dspace_rows:
            ...
            sql = 'INSERT INTO `usr_notification`(`EmpID`,`search_hst`, `FILEPATH`, `SOURCE`, `mark`) VALUES (%s, %s, %s,%s,%s)'
            values = (EMPID, TITLE_arma, FILEPATH, SOURCE, MARK)
