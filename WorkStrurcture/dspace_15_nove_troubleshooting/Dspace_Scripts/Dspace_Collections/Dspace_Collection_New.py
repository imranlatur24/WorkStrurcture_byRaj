...
logging.basicConfig(
    ...
    filename = datetime.now().strftime('DSPACE_Collection_%d-%b-%Y.log'),
...
def read_files(folder_path):
    for data_file in sorted(os.listdir(folder_path)):
        file_scrapping("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace/Collection/" + data_file)
#remove_csv()
#remove_data()
read_files("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace/Collections/")
