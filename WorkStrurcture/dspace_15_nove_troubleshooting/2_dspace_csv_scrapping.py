...
def sql_conn(hostname,username,password,dbname):
    ...
    return myconn
###################################################
engine = create_engine("mysql+pymysql://root@localhost/15_nov_dspace")
engine.connect()
########################################### collection_14_16_19_20_create_csv ############################################################################
filepath_14_16_19_20 = "E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/Collections/"
#remove existing data into dspace db before scrapping and insert new one
def collection_14_16_19_20_create_csv(file_path,data_file):
        with open(file_path, encoding='cp437'):
            ...
            df3.to_csv("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/collection_csv_new_mytitle/"+data_file)
            print(df3)
...
def collection_14_16_19_20_read_files(folder_path):
    for data_file_db in sorted(os.listdir(folder_path)):
        collection_14_16_19_20_SQL("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/collection_csv_new_mytitle/" + data_file_db)
collection_14_16_19_20_read_files("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/collection_csv_new_mytitle/")

################################################ community_1_3_30_34_create_csv ########################################################################
filepath_Community_1_3_30_34 = "E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/Community/"
def community_1_3_30_34_create_csv(file_path, data_file):
    with open(file_path, encoding='cp437'):
        ...
        # https://stackoverflow.com/questions/50982727/using-duplicates-values-from-one-column-to-remove-entire-row-in-pandas-dataframe
        df3 = df3.drop_duplicates(subset=['dc.identifier.uri'], keep='first')
        df3.to_csv("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/community_csv_new_mytitle/" + data_file)
        print(df3)
def count_files(dir):
    return len([1 for x in list(os.scandir(dir)) if x.is_file()])
...
def community_1_3_30_34__SQL_read_files(folder_path):
    for commdata_file_db in sorted(os.listdir(folder_path)):
        community_1_3_30_34__SQL("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/community_csv_new_mytitle/" + commdata_file_db)
community_1_3_30_34__SQL_read_files("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/community_csv_new_mytitle/")

################################################## community 23 create_csv ##################################################
filepath_23 = "E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/23/"
#remove existing data into dspace db before scrapping and insert new one
def community_23(file_path,data_file):
        with open(file_path, encoding='cp437'):
            ...
            df3.to_csv("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/23_community_csv_new_mytitle/"+data_file)
            # print(df3)
def count_files(dir):
    return len([1 for x in list(os.scandir(dir)) if x.is_file()])
...
def community_23_sql_read_files(folder_path):
    for data_file in sorted(os.listdir(folder_path)):
        community_23_sql("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/23_community_csv_new_mytitle/" + data_file)
community_23_sql_read_files("E:/WorkStrurcture_byRaj/WorkStrurcture/dspace_15_nove_troubleshooting/23_community_csv_new_mytitle/")
